...
namespace ycsbc {
    ...
    int PMBTree::Scan(const std::string &table, const std::string &key, int len, const std::vector<std::string> *fields,
    ...
    int PMBTree::Insert(const std::string &table, const std::string &key,
    ...
    int PMBTree::Update(const std::string &table, const std::string &key, std::vector<KVPair> &values) {
        return Insert(table,key,values);
    }

    int PMBTree::Delete(const std::string &table, const std::string &key) {
    ...
    void PMBTree::PrintStats() {
        cout<<"read not found:"<<noResult<<endl;
    }

    bool PMBTree::HaveBalancedDistribution() {
        return true;
    }
    ...
    void PMBTree::PutFixed64(std::string* dst, uint64_t value) {
    ...
    void PMBTree::SerializeValues(std::vector<KVPair> &kvs, std::string &value) {
        value.clear();
    ...
    void PMBTree::DeSerializeValues(std::string &value, std::vector<KVPair> &kvs){
        uint64_t offset = 0;
        uint64_t kv_num = 0;
        uint64_t key_size = 0;
